...
{
    resize(900, 520);
    setWindowTitle(tr("ReliefProject") + " - " + tr("Wallet"));
#ifndef Q_OS_MAC
...
#endif
    setObjectName("ReliefProject");
    setStyleSheet("#ReliefProject { background-color: #ffffff}");
...
void BitcoinGUI::createActions()
{
    ...
    sendCoinsAction->setToolTip(tr("Send coins to a ReliefProject address"));
    ...
    aboutAction = new QAction(tr("&About ReliefProject"), this);
    aboutAction->setToolTip(tr("Show information about ReliefProject"));
    aboutAction->setMenuRole(QAction::AboutRole);
    aboutQtAction = new QAction(tr("About &Qt"), this);
    aboutQtAction->setToolTip(tr("Show information about Qt"));
    aboutQtAction->setMenuRole(QAction::AboutQtRole);
    optionsAction = new QAction(tr("&Options..."), this);
    optionsAction->setToolTip(tr("Modify configuration options for ReliefProject"));
...
void BitcoinGUI::setClientModel(ClientModel *clientModel)
{
    ...
    if(clientModel)
    {
        ...
        if(clientModel->isTestNet())
        {
            ...
            if(trayIcon)
            {
                trayIcon->setToolTip(tr("ReliefProject client") + QString(" ") + tr("[testnet]"));
...
void BitcoinGUI::createTrayIcon()
{
    ...
    trayIcon->setToolTip(tr("ReliefProject client"));
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to ReliefProject network", "", count));
}
...
{
    QString strTitle = tr("ReliefProject") + " - ";
...
void BitcoinGUI::dropEvent(QDropEvent *event)
{
    if(event->mimeData()->hasUrls())
    {
        ...
        if (nValidUrisFound)
            ...
            notificator->notify(Notificator::Warning, tr("URI handling"), tr("URI can not be parsed! This can be caused by an invalid ReliefProject address or malformed URI parameters."));
    }
