...
void AddEditAdrenalineNode::on_okButton_clicked()
{
    ...
    {
        QMessageBox msg;
        msg.setText("Please enter an ip address and port. (123.45.67.89:10559)");
        msg.exec();
        return;
    }
    ...
    {
        QMessageBox msg;
        msg.setText("Please enter the transaction hash for the transaction that has 30,000 coins");
        msg.exec();
        return;
    }
