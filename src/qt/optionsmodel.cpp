...
void OptionsModel::Init()
{
    ...
    if (!settings.contains("nAnonymizeReliefProjectAmount"))
        settings.setValue("nAnonymizeReliefProjectAmount", 1000);
    nAnonymizeReliefProjectAmount = settings.value("nAnonymizeReliefProjectAmount").toLongLong();
    if (settings.contains("nDarksendRounds"))
        SoftSetArg("-darksendrounds", settings.value("nDarksendRounds").toString().toStdString());
    if (settings.contains("nAnonymizeReliefProjectAmount"))
        SoftSetArg("-anonymizeReliefProjectamount", settings.value("nAnonymizeReliefProjectAmount").toString().toStdString());
...
QVariant OptionsModel::data(const QModelIndex & index, int role) const
{
    if(role == Qt::EditRole)
    {
        ...
        case AnonymizeReliefProjectAmount:
            return QVariant(nAnonymizeReliefProjectAmount);
        case UseBlackTheme:
...
bool OptionsModel::setData(const QModelIndex & index, const QVariant & value, int role)
{
    ...
    if(role == Qt::EditRole)
    {
        ...
        case DarksendRounds:
            ...
            break;
        case AnonymizeReliefProjectAmount:
            nAnonymizeReliefProjectAmount = value.toInt();
            settings.setValue("nAnonymizeReliefProjectAmount", nAnonymizeReliefProjectAmount);
            emit AnonymizeReliefProjectAmountChanged(nAnonymizeReliefProjectAmount);
            break;
        default:
            break;
        }
